...
import com.camel.poc.bean.CunsulRegisterPojo;

@Component
public class ConsulRegistration extends EventNotifierSupport {
	...
	public void notify(EventObject event) throws Exception {
		if (event instanceof CamelContextStartedEvent) {
			...
			t.sendBody("direct:start",
					new CunsulRegisterPojo("customer" + port, "customer", "127.0.0.1", port));
